...
2. Go to editor: http://localhost:3000/admin/editor
3. Copy the content above
4. Fill in:
   - Title: How a 'Simple' Telegram Bot Turned Into a Full Payment System
   - Slug: telegram-bot-payment-system
   - Excerpt: (copy from above)
   - Content: (copy from above, format in the editor)
5. Click PUBLISH

**Or use this curl command with auth token:**
