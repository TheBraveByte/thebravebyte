<template>
  <footer class="bg-bg border-t border-border py-12 relative overflow-hidden">
    <!-- Background Grid -->
    ...
    <div class="container mx-auto px-6 relative z-10">
      <div class="grid md:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          <h3 class="font-mono text-[10px] text-text-secondary uppercase tracking-wider mb-4 border-b border-border pb-2 inline-block">
            NAV_PROTOCOLS
          </h3>
          <ul class="space-y-2">
      ...
      <div class="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="font-mono text-[10px] text-text-secondary flex items-center gap-4">
